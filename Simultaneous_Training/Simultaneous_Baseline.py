...
dataset_kabyle = load_dataset(kabyle_dataset_name, trust_remote_code=True, split={"train": "train[:3365]", "test": "test[:1443]"})
dataset_arabic = load_dataset(arabic_dataset_name, trust_remote_code=True)
dataset_french = load_dataset(french_dataset_name, trust_remote_code=True, split={"train": "train[:3365]", "test": "test[:1443]"})
...
total_train = concatenate_datasets([kab_train, arab_train, frc_train])
total_test  = concatenate_datasets([kab_test,  arab_test,  frc_test ])
