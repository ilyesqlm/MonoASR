...
## We used datasets that are hosted on my Hugging Face Hub. These are the same datasets described in the paper, 
...
#dataset = dataset.remove_columns(["syllables","syllable_classes"])
...
def clean_text(batch):
    batch["transcription"] = re.sub(r'[\xa0\u202f\u200b]', ' ', batch["transcription"])
    return batch
...
def main(repo_name="MMS_wolof", target_lang = "wol", dataset=dataset, processor=processor):
